...
void rebootAction() 
{
    UIAlertController *alert = [UIAlertController alertControllerWithTitle:Localized(@"Warnning") message:Localized(@"Are you sure to reboot device?") preferredStyle:UIAlertControllerStyleAlert];
